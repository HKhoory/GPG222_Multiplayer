...
namespace Leonardo.Scripts.Abilities
{
    ...
    {
        [Tooltip("List of ability components attached to this player")]
        [SerializeField] private List<AbilityBase> abilities = new();
        
        [Header("- Input Settings")]
        [Tooltip("Key to activate the first ability")]
        [SerializeField] private KeyCode ability1Key = KeyCode.Q;
        [Tooltip("Key to activate the second ability")]
